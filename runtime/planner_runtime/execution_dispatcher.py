...
DISPATCH = {"reconcile":"/opt/nexifyai-platform/runtime/reconciliation/auto_reconciler.py","govern":"/runtime/github_governance/issue_autogenerator.py","recover":"/runtime/incidents/incident_manager.py","observe":"/opt/nexifyai-platform/runtime/watchdog/runtime_watchdog.py","learn":"/runtime/learning/organizational_learning_engine.py"}
