...
ROTATION_LOG = "/runtime/security/rotation/rotation_history.json"
...
class RotationEngine:
    ...
    def check_due(self, registry_path="/runtime/security/vault/registry.json"):
    ...
    def rotate_secret(self, name, secret_type, registry_path="/runtime/security/vault/registry.json"):
        ...
        # Audit log
        with open("/runtime/security/audit/events.log", "a") as f:
