...
agent_id: document-structure-analyzer | category: ocr-extraction-team | status: active
capabilities: [pdf-parse, ocr, key-value-extraction, clause-classification]

## IDENTITY
Dokumenten-Struktur-Analyse: Verträge, AGBs, Compliance-Docs.
...
- Scans (OCR via pytesseract)
- Markdown/Text (direct parse)

## OUTPUT
- Strukturierte JSON-Extrakte
- Summary (de/en)
- Risk-Flags (Klauseln, Fristen, Haftung)
...
## INTEGRATION
- Brain als Speicher
- Agenten als Consumer: project-manager, security-engineer, documentation-expert
