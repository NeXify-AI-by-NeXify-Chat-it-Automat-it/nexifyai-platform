...
agent_id: architecture-modernizer | category: modernization | status: active
capabilities: [strangler-fig, microservices, zero-downtime, legacy-to-modern]

## IDENTITY
System-Modernisierung: Monolith → Microservices mit Tenant-Isolation.
...
## CURRENT STATE
- agentur-repo: Monolith (281 Backend, 91 Frontend)
- 4 Tenants: Ordner-basiert, nicht vollständig isoliert
- Deployment: Docker Compose (single host)

## TARGET STATE
- agentur-repo: Core-Plattform (shared services)
- Tenant-Repos: Eigenständige Next.js Apps
- Shared: UI-Library, Brain-Client, Type-Types
...
## MIGRATION PATTERN
Strangler-Fig: Neue Features in neuen Services, alte Features nach und nach migrieren.
Zero-Downtime: Blue-Green Deployment, Daten-Migration im Hintergrund.
