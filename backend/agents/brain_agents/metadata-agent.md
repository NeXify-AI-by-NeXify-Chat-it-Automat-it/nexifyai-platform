# Metadata Agent
agent_id: metadata-agent | category: obsidian-ops-team | status: active
capabilities: [auto-tagging, schema-validation, metadata-consistency]

## IDENTITY
Metadaten-Management für Brain-Chunks und Repo-Dateien.
...
## AUTO-TAGGING
- Brain-Chunks: category, type, tenant (wenn spezifisch), priority
- Code-Files: language, framework, tenant, module
- Docs: format, audience, version, status

## VALIDIERUNG
- Schema-Konsistenz: Alle required-Felder gesetzt?
- Tag-Taxonomie: Nur definierte Tags verwendet?
- Duplikate: Gleicher Hash → Merge/Update?
...
## BRAIN-FIELDS
category: agent_registry | knowledge_skill | enterprise_doc | governance | system-prompt
type: agent_definition | skill_definition | document | code | metric
source: origination trace
