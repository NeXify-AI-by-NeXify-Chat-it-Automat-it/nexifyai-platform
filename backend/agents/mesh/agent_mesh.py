...
class AgentRegistry:
    ...
    def _register_default_agents(self):
        """Register the standard 16-agent mesh."""
        defaults = [
            AgentCapability("oracle", AgentDomain.ORACLE, "Parses intent, routes to specialists",
                          tools=["llm", "brain"], risk_limit=0.0, max_blast_radius=0, max_parallel_tasks=1),
            AgentCapability("planner", AgentDomain.PROGRAM_MANAGER, "Creates execution plans, manages dependencies",
                          tools=["llm", "brain", "registry"], risk_limit=0.0, max_blast_radius=0, max_parallel_tasks=2),
            AgentCapability("architect", AgentDomain.ARCHITECT, "System design, architecture compliance",
                          tools=["dos", "adr", "brain"], risk_limit=0.05, max_parallel_tasks=2),
            AgentCapability("frontend-react", AgentDomain.FRONTEND, "React/Next.js UI components",
            ...
            AgentCapability("database", AgentDomain.DATABASE, "Supabase, migrations, queries",
                          tools=["supabase", "psql"], risk_limit=0.12, max_parallel_tasks=2),
            AgentCapability("devops", AgentDomain.DEVOPS, "CI/CD, Docker, infrastructure",
                          tools=["docker", "github", "ssh"], risk_limit=0.15, max_blast_radius=3, requires_human=True, max_parallel_tasks=2),
            AgentCapability("deployment", AgentDomain.DEPLOYMENT, "Vercel deploy, DNS, health checks",
                          tools=["vercel", "curl"], risk_limit=0.10, max_blast_radius=2, max_parallel_tasks=2),
            AgentCapability("security", AgentDomain.SECURITY, "Security audits, secret scanning, CSP",
            ...
            AgentCapability("seo", AgentDomain.SEO, "SEO audit, meta tags, schema, Core Web Vitals",
                          tools=["lighthouse", "screaming-frog"], risk_limit=0.02, max_parallel_tasks=2),
            ...
            AgentCapability("graphic", AgentDomain.GRAPHIC, "Images, icons, OG images, design assets",
                          tools=["sharp", "figma"], risk_limit=0.01, max_parallel_tasks=2),
            AgentCapability("analytics", AgentDomain.ANALYTICS, "Telemetry, dashboards, metrics",
