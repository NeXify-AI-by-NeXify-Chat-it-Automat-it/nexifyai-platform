...
TIMERS = {
    "nexify-pulse-5min": {"on": "*:0/5", "cmd": "/services/runtime/rhythm/enterprise_pulse.py 5min"},
    "nexify-heartbeat-5min": {"on": "*:1/5", "cmd": "/services/runtime/rhythm/organization_heartbeat.py"},
    "nexify-cycle-ctrl-5min": {"on": "*:2/5", "cmd": "/services/runtime/rhythm/organizational_cycle_controller.py"},
    "nexify-maturity-hourly": {"on": "0:0", "cmd": "/services/runtime/rhythm/runtime_maturity_evaluator.py"},
}
def gen(name=None):
