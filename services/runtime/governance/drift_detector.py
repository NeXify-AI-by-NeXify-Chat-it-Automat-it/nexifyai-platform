...
REQUIRED_DIRS = [
    ...
    "/opt/nexifyai-platform/services/runtime/reconciliation",
    "/opt/nexifyai-platform/services/runtime/convergence",
    "/opt/nexifyai-platform/services/runtime/governance",
]
FORBIDDEN_PATTERNS = [
    ".addr.",
