...
3 Services benötigen Auth: OpenRouter, Brain API, Traefik Dashboard. Kein Single-Sign-On bisher.
...
|---------|-------------|---------------|
| OpenRouter | JWT (HS256) | JWT_SECRET in /root/.secrets/credentials.env |
