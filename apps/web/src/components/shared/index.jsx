...
export const COMPANY = {
  ...
  phone: '+31 6 133 188 56', email: 'support@nexifyai.cloud', web: 'nexifyai.cloud', kvk: '90483944', vat: 'NL865786276B01', addr: { nl: { s: 'Graaf van Loonstraat 1E', c: '5921 JA Venlo' } }
};
